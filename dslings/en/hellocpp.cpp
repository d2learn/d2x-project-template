...
//      - D2X_YOUR_ANSWER: This identifier is used to prompt you to modify the code, generally for code
//        completion (replace this identifier with the correct code).
//
...
// The new d2x functions support colored output and source file location information
...
int main() {
    ...
    d2x::wait(); // 5. Delete or comment out this function call to proceed to the next exercise (formal code practice)
